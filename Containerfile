...
RUN pkg update && \
    ...
    pip-3.11 install --no-cache-dir sabctools && \
    chmod -R a+rX /usr/local/lib/python3.11/site-packages/sabctools* && \
...
COPY --from=builder /usr/local/lib/python3.11/site-packages/sabctools /usr/local/lib/python3.11/site-packages/sabctools
COPY --from=builder /usr/local/lib/python3.11/site-packages/sabctools-9.4.0.dist-info /usr/local/lib/python3.11/site-packages/sabctools-9.4.0.dist-info
